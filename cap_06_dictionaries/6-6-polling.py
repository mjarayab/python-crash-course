# Use the code in favorite_languages.py (page 96). Make a list of people who 
# should take the favorite languages poll. Include some names that are already 
